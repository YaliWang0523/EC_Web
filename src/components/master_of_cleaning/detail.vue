<template >
  <div>
    ...
    <div class="container">
      ...
      <div class="row mt-3">
        <div class="col">
          <h1 class="float-left text-primary">案件明細912730</h1>
        </div>
              ...
              <div class="tab-content" id="nav-tabContent">
                  ...
                  <form>
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-4">
                        ...
                        <input type="text" class="form-control" id="inputName" placeholder="輸入業主名字">
                      </div>
                      <!-- /預約業主 -->
                      <!-- Form Group 聯絡電話 -->
                      <div class="form-group col-4">
                        <label for="inputTel" class="font-weight-bold">聯絡電話</label>
                        <input type="text" class="form-control" id="inputTel" placeholder="0978-578-978">
                      </div>
                      <!-- /Form Group 聯絡電話 -->
                      <!-- Form Group Email -->
                      <div class="form-group col-4">
                      ...
                      <div class="form-group col-8">
                        ...
                        <input type="text" class="form-control" id="inputAddr" placeholder="高雄市左營區博愛三路978號">
                      </div>
                      <!-- /Form Group 施做地址 -->
                    </div>
                    <!-- Form Row -->
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-4">
                        ...
                        <select class="form-control" id="selectServiceDetail">
                          <option>1位管家</option>
                          <option>2位管家</option>
                          <option>3位管家</option>
                        </select>
                      ...
                      <div class="form-group col-4" >
                        ...
                        <input type="text" class="form-control" id="inputMoneySum" placeholder="30,000">
                      </div>
                      <!-- /Form Group 聯絡電話-->
                      <!-- Form Group 服務時段 -->
                      <div class="form-group col-12">
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                  ...
                  <form>
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-4">
                        ...
                        <select class="form-control" id="selectProCompany">
                          <option>壞媳婦好朋友清潔公司</option>
                          <option>大媽樂清潔公司</option>
                          <option>爸爸樂清潔公司</option>
                        </select>
                      </div>
                      <!-- /Form Group 服務單位-->
                      <!-- Form Group 施做地址 -->
                      ...
                      <div class="form-group col-4">
                        ...
                        <input type="text" class="form-control" id="inputProTel" placeholder="0978-578-978">
                      </div>
                      <!-- /Form Group 聯絡電話 -->
                      <!-- Form Group Email -->
                      <div class="form-group col-4">
                        <label for="inputProEmail" class="font-weight-bold">Email</label>
                        <input type="text" class="form-control" id="inputProEmail" placeholder="abc@gmail.com">
                      </div>
                      <!-- /Form Group Email -->
                    </div>
                    <!-- /Form Row -->
                  ...
                  <div class="row justify-content-center">
                    ...
                    <div class="col text-center">
                      <a href="#" class="btn btn-outline-primary btn-lg " role="button" aria-pressed="true">取消編輯</a>
                      <a href="#" class="btn btn-primary btn-lg " role="button" aria-pressed="true">確認派工</a>
                    </div>
                    <!-- /Col -->
                  </div>
                  <!-- /Action Buttons -->
                ...
                <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                  ...
                  <form>
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-8">
                        ...
                        <textarea class="form-control" id="textareaFeedback" rows="3"></textarea>
                      </div>
                    </div>
                    <!-- /Form Row -->
                  </form>
                  ...
                  <div class="row justify-content-center">
                    ...
                    <div class="col text-center">
                      <a href="#" class="btn btn-outline-primary btn-lg " role="button" aria-pressed="true">取消編輯</a>
                      <a href="#" class="btn btn-primary btn-lg " role="button" aria-pressed="true">確認結案</a>
                    </div>
                    <!-- /Col -->
                  </div>
                  <!-- Action Buttons -->
